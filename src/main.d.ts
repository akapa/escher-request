...
export function post(url: string, config: EscherRequestConfig): Promise<EscherRequestResponse>;
export function put(url: string, config: EscherRequestConfig): Promise<EscherRequestResponse>;
declare function _delete(url: string, config: EscherRequestConfig): Promise<EscherRequestResponse>;
export { _delete as delete }
export function patch(url: string, config: EscherRequestConfig): Promise<EscherRequestResponse>;
